    ...
    <div className="terms-page">
      ...
      <div className="terms-container">
        <section className="terms-section">
          ...
          <p>
            {orgName} is an independent virtual picks platform designed for entertainment purposes.
        ...
        <section className="terms-section">
          ...
          <p>
            ...
            are responsible for supervising their child's use of the platform. No real money is involved — all picks
            use virtual {currencyName}.
          </p>
        </section>
        ...
        <section className="terms-section">
          ...
          <p>
            {currencyName} are virtual currency with no real monetary value. They cannot be exchanged for cash,
            transferred outside the platform, or used for any transaction outside of {orgName}. All balances
        ...
        <section className="terms-section">
          ...
          <p>
            <strong>Security Commitment:</strong> {orgName} uses industry-standard encryption to protect your password
        ...
        <section className="terms-section">
          ...
          <p>
            All picks must be placed before the game begins. Once a game concludes, the system will automatically
            calculate results. Admin users reserve the right to manually resolve picks if necessary due to disputed
            outcomes. Picks cannot be refunded or reversed except in cases of administrative error.
          </p>
        </section>
        ...
        <section className="terms-section">
          ...
          <p>
            {orgName} is created purely for entertainment and community engagement. The platform has absolutely
            <strong> zero intentions of causing harm, making fun of anyone, or being disrespectful in any way</strong>.
            This is a fun, inclusive space designed to bring your community together and increase engagement with sports.
          </p>
          <p>
        ...
        <section className="terms-section">
          ...
          <p>
            ...
            any school, organization, or institution</strong> beyond the organization that configured and runs it.
            The platform is created for entertainment and community engagement purposes only.
          </p>
        </section>
        ...
        <section className="terms-section">
          ...
          <p>
            {orgName} is provided "as is" without warranties. We are not liable for technical issues, data loss,
        ...
        <section className="terms-section final-section">
          <h2>Questions?</h2>
          <p>
            If you have questions about these Terms, please reach out to the platform administrator. We're committed
            to maintaining a safe, enjoyable platform for everyone.
          </p>
        </section>
      </div>
    </div>
